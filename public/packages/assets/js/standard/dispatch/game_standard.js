    ...
    game:{
        ...
        salir:function(){
          ...
          start:function(){
            ...
            document.querySelector("iframe[name='iframe_juego']").setAttribute("src","/packages/assets/iframes/games/"+document.querySelector("iframe[name='iframe_juego']").getAttribute("data-folder")+"/index.html?"+Math.random());
          }
        },

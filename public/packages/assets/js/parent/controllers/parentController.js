       ...
       createChartActivities:function(id,nivelId,dataset){
            ...
            if(dataset.length == 0){
                ...
                data.datasets.push({
                    ...
                    borderColor: Curiosity.colorsTransparent(1)[numRand],
                    borderCapStyle: 'butt',
                    borderDash: [],
                    borderDashOffset: 0.0,
                    borderJoinStyle: 'miter',
                    pointBorderColor: Curiosity.colorsTransparent(1)[numRand],
                    pointBackgroundColor: "#fff",
                    pointBorderWidth: 1,
                    pointHoverRadius: 5,
                    pointHoverBackgroundColor: Curiosity.colorsTransparent(1)[numRand],
                    pointHoverBorderColor: Curiosity.colorsTransparent(1)[numRand],
                    pointHoverBorderWidth: 2,
                    pointRadius: 1,
                    pointHitRadius: 10,
                    spanGaps: false

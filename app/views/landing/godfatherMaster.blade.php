...
<head name="theme-color">
	<meta charset="UTF-8">
	<link rel="icon" type="image/png" href="/packages/assets/media/images/landing/logo-padrino.png">
	<meta http-equiv="X-UA-Compatible" content="IE=Edge">
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0">
	<meta name="keywords" content="Padrino,Apadrinar,Donar, Apoyar, Educación, juegos, juegos educativos , juegos de primaria , tarea, escuela, videos para niños, videos animados">
	...
	<link rel="stylesheet" href="/packages/assets/css/landing/style-padrino-index.css?{{rand();}}">
 	@yield('css')
	<title>@yield('title')</title>
</head>
<body>
<!--Navbar-->
<nav class="navbar navbar-dark navbar_inicio navbar-fixed-top scrolling-navbar">
	<!-- Collapse button-->
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-toggleable-xs" id="collapseEx2">
			...
			<a href="/" class="navbar-brand pull-left  chicle font-curiosity">
				<span><img src="/packages/assets/media/images/landing/logo-padrino.png?{{rand();}}" alt="logo-curiosity" class="logo-current"></span>
				Padrino Curiosity
			</a>
			<!--Links-->
...
<!-- Fin de preloader -->
	...
	<script type="text/javascript" src="/packages/assets/js/landing/app-padrino-index.js"></script>

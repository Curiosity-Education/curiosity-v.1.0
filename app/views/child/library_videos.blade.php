...
<div class="container-fluid">
	...
	<div class="row">
		...
		<div class="row" id="lp-row-degrees">
			<div class="col-md-11 col-sm-12 col-lg-11 lp-container-degrees z-depth-1">
...
@section('js-plus')
	...
	<script type="text/javascript" src="/packages/assets/js/child/models/dist/library-videos-dist.js?{{rand();}}"></script>
